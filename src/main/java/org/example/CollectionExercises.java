...
public class CollectionExercises {
    ...
    public String[] makeTopThreeArray(String[] fruits) {
        ...
        // Replace the line below with your implementation
        String[] topThree = Arrays.copyOf(fruits, 3);
        return topThree;
    }
    ...
    public ArrayList<String> makeFruitList() {
        ...
        // "apple", "banana", "cherry", "date", "elderberry"
        // Replace the line below with your implementation
        ArrayList <String> newFruitArray = new ArrayList<String>();
        newFruitArray.add("apple");
        newFruitArray.add("banana");
        newFruitArray.add("cherry");
        newFruitArray.add("date");
        newFruitArray.add("elderberry");
